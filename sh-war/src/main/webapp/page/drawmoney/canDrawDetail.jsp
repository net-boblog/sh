...
<head>
  ...
  <script type="text/javascript" src="<%=ctx%>/page/drawmoney/canDrawDetail.js"></script>
</head>
<body>
<div class="content">
    ...
    <div class="wrap_right">
      ...
      <div class="radiu">
       <div class="jiesuan_money_box ">
        <span class="js_amount">${canDraw}</span>
        <span class="dd_amount">${ordeCanDraw}</span>
        <span class="jl_amount">${reward}</span>
        </div>
      </div>
      ...
      <div class="tk_records radiu">
        ...
        <tr>
         ...
         <td style="text-align:right;"> <div class="all_order">共<span id="total_order"></span>个订单</div></td>
        </tr>
        </table>
