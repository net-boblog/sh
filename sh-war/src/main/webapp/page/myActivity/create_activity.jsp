...
<div class="content">
  ...
  <div class="box_right">
    ...
    <div class="wrap_right">
      <div class="title_mune">活动管理 &gt; 发布活动</div>
       <form id="signupForm">
      <div class="radiu" style="padding-bottom: 0">
        <input type="hidden" id="cycleTimes" name="cycleTimes" value="1"/>
        <table class="edit_active">
          <tr>
            <td class="edit_firsttd"><span class="red">*</span>活动促销</td>
            <td><span class="edit_after"><input type="text" id="name" name="name" value="" class="activecuxiao"></span>
            </td>
          </tr>
          <tr>
            ...
            <td>
				<span class="edit_after">
                      ...
                      <select id="secondCategoryId" name="secondCategoryId" class="seviceobj">
                              <option value="">请选择</option>
                      </select>
				</span>
            </td>
          ...
          <tr>
            ...
            <td><span class="edit_after">
                      ...
                      <input type="text" class="Wdate" id="endTime" name="endTime" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startTime\')}'})"
                             value="" style="width:129px; height:30px; margin-left:5px; border:#eee 1px solid;" /> </span>
          ...
          <tr>
            ...
            <td><span><input type="text" class="shortinput" id="saleNumber" name="saleNumber" value=""> 件</span><p class="edit_text">商家发起该活动所提供的服务数量</p></td>
          </tr>
          <tr>
            <td class="edit_firsttd"><span class="red">*</span>限购周期</td>
            <td><span><input type="text" class="shortinput" id="cycleDays" name="cycleDays" value=""> 天/次</span><p class="edit_text">车主在一定周期内只能享受一次优惠，例7天/次，表示7天内该用户只能享受此活动1次</p></td>
          </tr>
          <tr>
            <td class="edit_firsttd"><span class="red">*</span>商户补贴金额</td>
            <td><span><input type="text" class="shortinput" id="merchantAllowance" name="merchantAllowance" value=""> 元</span><p class="edit_text">商户提供的优惠额度，设置的金额数字＞0</p></td>
          </tr>
        </table>
      </div>
     </form>
...
<script type="text/javascript" src="<%=ctx%>/page/myActivity/create_activity.js?v=20160312"></script>
